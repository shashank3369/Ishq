    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                Text("A community of high-intentioned South Asians.").bold().padding(.bottom, 100).padding(.top, 20).font(.BaskerVilleItalicBody).multilineTextAlignment(.center)
                Group {
                    ...
                    Button {
                        ...
                        NavigationLink(destination: PhoneAuthentication()) {
                            Text("Sign in with Phone Number").font(.InterTitle3).fontWeight(.bold)}
